...
The data file will be generated by a GitHub action and committed to the repo. That commit flagged with commit message that prevents further build triggers - `[skip ci]`
