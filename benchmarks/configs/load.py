...
def select_config(experiment: str) -> dict:
    ...
    disk_experiment_names = [field.name for field in fields(DiskExperiments)]
    ...
    elif experiment in disk_experiment_names:
        from benchmarks.configs.surface_sm_inference import CONFIGS as DISK_EXPERIMENTS
