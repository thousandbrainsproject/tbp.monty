...
base_config_10distinctobj_surf_agent_detailed = copy.deepcopy(
    base_config_10distinctobj_surf_agent
)
base_config_10distinctobj_surf_agent_detailed["logging_config"] = (
    DetailedEvidenceLMLoggingConfig(
        wandb_handlers=[],
    )
)
base_config_10distinctobj_surf_agent_detailed["monty_config"].learning_module_configs[
    "learning_module_0"
]["learning_module_args"]["use_multithreading"] = False

randrot_noise_10distinctobj_surf_agent_detailed = copy.deepcopy(
    randrot_noise_10distinctobj_surf_agent
)
randrot_noise_10distinctobj_surf_agent_detailed["logging_config"] = (
    DetailedEvidenceLMLoggingConfig(
        wandb_handlers=[],
    )
)
