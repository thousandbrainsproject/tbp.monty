...
from tbp.monty.frameworks.utils.edge_detection import gradient_to_tangent_angle, is_geometric_edge
...
class IsGeometricEdgeTest(unittest.TestCase):
    ...
    @example(patch=np.full((PATCH_SIZE, PATCH_SIZE), 1.0, dtype=np.float32),
             theta=0.0, threshold=0.01)
