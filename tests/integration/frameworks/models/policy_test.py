...
class PolicyTest(unittest.TestCase):
    ...
    def test_touch_object_basic_surf_agent(self):
        ...
        exp: MontyExperiment = hydrate_experiment(
    ...
    def test_distant_policy_moves_back_to_object(self):
        ...
        """
        exp: MontyExperiment = hydrate_experiment(self.dist_fixed_action_cfg.experiment)
        with exp:
            exp.experiment_mode = ExperimentMode.TRAIN
            exp.model.set_experiment_mode(exp.experiment_mode)
            exp.pre_epoch()
    ...
    def test_surface_policy_moves_back_to_object(self):
        ...
        off of the cube.
        """
        exp: MontyExperiment = hydrate_experiment(self.surf_fixed_action_cfg.experiment)
        with exp:
            exp.experiment_mode = ExperimentMode.TRAIN
            exp.model.set_experiment_mode(exp.experiment_mode)
            exp.pre_epoch()
    ...
    def test_surface_policy_orientation(self):
        ...
        """
        exp: MontyExperiment = hydrate_experiment(self.rotated_cube_view_cfg.experiment)
        with exp:
            exp.experiment_mode = ExperimentMode.TRAIN
            exp.model.set_experiment_mode(exp.experiment_mode)
            exp.pre_epoch()
