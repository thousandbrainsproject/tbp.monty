...
| **SalienceSM** | A wide field-of-view sensor module that proposes locations to attend to. Implements return-of-inhibition, and can be configured with different strategies for ranking target locations. |
