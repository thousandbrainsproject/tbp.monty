...
| **TwoDSensorModule**             | Sensor module connected that learns a 2D surface models of 3D objects. When enabled, it can also extract edges within objects as `pose_vectors`.                                                                                                                                                                               |
