...
We have developed a separate repository called [tbp.ultrasound_perception](https://github.com/thousandbrainsproject/tbp.ultrasound_perception), and we welcome contributions to improve Monty's performance in this domain. To help track items of work, this Future Work item is marked as `evergreen`, and we use individual Issues in the `tbp.ultrasound_perception` repository.