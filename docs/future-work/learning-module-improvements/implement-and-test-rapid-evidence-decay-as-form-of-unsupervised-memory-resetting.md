...
> [!NOTE]
> The `BurstSamplingHypothesesUpdater` provides a complementary approach to handling object transitions. Rather than decaying evidence, it tracks evidence slopes and automatically deletes hypotheses that cease to accumulate evidence while sampling new ones when needed. See the [burst sampling](../../how-monty-works/learning-module/evidence-based-learning-module.md#burst-sampling) documentation for details.
