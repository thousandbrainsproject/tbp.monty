...
defaults:
  ...
  # use within Monty. We use a motor system with an InformedPolicy where
  # movement rotations are 5 degrees and we do not use goal driven actions.
  - /monty/motor_system_config: informed_5_goal0
