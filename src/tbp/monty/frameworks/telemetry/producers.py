...
class TelemetryEmitter:
    ...
    instances routed through the logging pipeline to telemetry consumers.
    ...
    def __init__(
        ...
        """Creates a telemetry emitter backed by named loggers.

        Loggers are namespaced under ``telemetry.*`` and ``snapshots.*``. Consumers
        elsewhere self-subscribe as handlers to specific loggers.
