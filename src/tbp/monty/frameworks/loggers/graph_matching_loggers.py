...
reporting, all handlers are called upon to send data to a destination. Handlers also receive
a standard set of arguments, most importantly the `self.data` pool.
...
level. The Detailed logger's data pool contains a superset of the data in the BASIC logger's
`self.data` attribute.
