...
def setup_env(monty_logs_dir_default: str = "~/tbp/results/monty/", monty_models_dir_default: str = "~/tbp/results/monty/", monty_data_dir_default: str = "~/tbp/data"):
    ...
    if monty_logs_dir is None:
        monty_logs_dir = str(Path(monty_logs_dir_default).expanduser())
    ...
    if monty_models_dir is None:
        monty_models_dir = str(Path(monty_models_dir_default).expanduser() / "pretrained_models")
    ...
    if monty_data_dir is None:
        monty_data_dir = str(Path(monty_data_dir_default).expanduser())
