...
class ResamplingHypothesesUpdater:
    ...
    Note:
        It would be better to decouple the number of hypotheses added from the number
        ...
        the number of hypotheses sampled equals the number removed. Ideally, we can
        decouple these decisions, then use a slope threshold to choose which hypotheses
        to remove and use prediction error or other heuristics to decide how many
