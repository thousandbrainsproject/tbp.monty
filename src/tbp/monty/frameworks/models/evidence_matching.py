...
from tbp.monty.frameworks.models.evidence_update import DefaultEvidenceUpdater
...
class EvidenceGraphLM(GraphLM):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.evidence_updater = DefaultEvidenceUpdater(
            evidence_update_threshold=evidence_update_threshold,
            feature_evidence_increment=feature_evidence_increment,
            feature_weights=feature_weights,
            graph_memory=self.graph_memory,
            initial_possible_poses=get_initial_possible_poses(initial_possible_poses),
    ...
    def _update_evidence(
        ...
        evidence_updates = self.evidence_updater.update_evidence(
