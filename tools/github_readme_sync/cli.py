...
def main():
    ...
    export_parser = subparsers.add_parser(
        "export",
        help="Export the readme docs and create a hierarchy.md file",
    )
    export_parser.add_argument(
        "folder",
        help="The directory where the exported docs will be stored",
    )
    ...
    check_parser = subparsers.add_parser(
        "check",
        help="Check the hierarchy.md file and ensure all docs exist",
    )
    check_parser.add_argument(
        "folder",
        help="The directory containing hierarchy.md and corresponding docs",
    )
    ...
    check_external_parser.add_argument(
        "folder",
        help="The directory containing markdown files to check",
    )
    check_external_parser.add_argument(
        "version",
        help="The version to check external links for",
    )
    check_external_parser.add_argument(
        "--ignore",
        nargs="*",
    ...
    delete_parser = subparsers.add_parser(
        "delete",
        help="Delete a specific version from ReadMe",
    )
    ...
    index_parser = subparsers.add_parser(
        "generate-index",
        help="Generate index.json from docs front-matter",
    )
    index_parser.add_argument(
        "folder",
        help="The docs directory to scan for markdown files",
    )
